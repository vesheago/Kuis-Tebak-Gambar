 ...
 * @author VESHEA GO
 */
public class DatabaseHighscore { //KELAS DATABASE: ISINYA BIKIN METHOD2 APA YANG BAKAL DIJALANIN DI VIEWNYA
        ...
        public boolean eksekusiQuery(String query){ //input data ke MySQL/DB

...
public class HighScore extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TOP TEN");

        tblScore.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    public JTable getTblScore() {
        return tblScore;
    }
    
    public int getSelectedScore(){
        return tblScore.getSelectedRow();
    }
    
    public void setTblScore(DefaultTableModel x){
        tblScore.setModel(x);
    }
